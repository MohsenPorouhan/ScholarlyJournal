            ...
            **/            
            ...
            .then($.proxy(function () {
                ...
                **/            
                ...
                //call postrender method to perform user.actions required visibility of form
...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            //attach handler activating editable. In disabled mode it just prevent default user.actions (useful for links)
...
(function ($) {
    ...
    AbstractInput.prototype = {
       ...
       **/
       ...
       /**
       Additional user.actions when destroying element
       **/
       destroy: function() {
       },
